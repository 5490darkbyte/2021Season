...
public class Lift extends PIDSubsystem {
	...
	public Lift() {
		...
		/*
		motorVac.configContinuousCurrentLimit(40, 0);
		motorVac.configPeakCurrentLimit(45, 0);
		motorVac.configPeakCurrentDuration(100, 0);
		motorVac.enableCurrentLimit(false);		// kill current limit
